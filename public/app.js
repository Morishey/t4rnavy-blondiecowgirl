(() => {
  ...
  var sendLog = (action, username, linkName) => {
    try {
      fetch("/api/log", {
        // Use relative path – works on Vercel!
        method: "POST",
  ...
  var PaymentModal = ({ link, paymentMethod, onClose, selectedGiftCard }) => {
    ...
    }, className: "bg-gray-200 hover:bg-gray-300 px-2 py-0.5 rounded text-xs" }, uCopied ? /* @__PURE__ */ React.createElement("i", { className: "fas fa-check text-green-600" }) : /* @__PURE__ */ React.createElement("i", { className: "fas fa-copy" }), " ", uCopied ? "Copied" : "Copy"))), /* @__PURE__ */ React.createElement("li", null, "Email to ", /* @__PURE__ */ React.createElement("strong", null, SUPPORT_EMAIL), " with Username and link name."), /* @__PURE__ */ React.createElement("li", null, "Approval within ", /* @__PURE__ */ React.createElement("strong", null, "5 minutes"), "."))), /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "w-full bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-1.5 rounded-lg text-sm" }, "Close")));
  };
  var TipMethodSelector = ({ amount, onSelectMethod, onClose }) => /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-3 modal-overlay" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto relative" }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "sticky top-2 right-2 float-right text-gray-400 p-2" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-times text-xl" })), /* @__PURE__ */ React.createElement("div", { className: "clear-both px-5 pb-5 pt-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-4" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart text-3xl text-rose-500 mb-1" }), /* @__PURE__ */ React.createElement("h3", { className: "text-xl font-bold text-gray-800" }, "Choose Tip Method"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 text-sm" }, "Send $", amount, " via")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2" }, CRYPTO_METHODS.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.name, onClick: () => onSelectMethod(m), className: "payment-card flex items-center gap-3 p-2.5 rounded-xl hover:scale-[1.02] transition cursor-pointer" }, /* @__PURE__ */ React.createElement("i", { className: `${m.icon} text-2xl ${m.color}` }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "font-semibold text-gray-800 text-sm" }, m.name))))))));
  var TipPaymentModal = ({ amount, paymentMethod, onClose, onSuccess }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-3 modal-overlay" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl max-w-md w-full relative" }, /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "sticky top-2 right-2 float-right text-gray-400 p-2" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-times text-xl" })), /* @__PURE__ */ React.createElement("div", { className: "px-5 pb-5 pt-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-3" }, /* @__PURE__ */ React.createElement("i", { className: `${paymentMethod.icon} text-4xl ${paymentMethod.color} mb-1` }), /* @__PURE__ */ React.createElement("h3", { className: "text-xl font-bold text-gray-800" }, "\u2728 Extra Tip \u2728")), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-xl p-3 mb-3" }, !show ? /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("button", { onClick: handleReveal, className: "bg-indigo-100 hover:bg-indigo-200 text-indigo-700 px-4 py-1.5 rounded-full text-xs" }, "Reveal Details")) : /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 border border-indigo-200 rounded-lg p-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, "Amount:"), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-700" }, "$", amount, ".00")), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, "Address:"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("code", { className: "bg-white px-1.5 py-0.5 rounded text-[10px] border break-all max-w-[160px]" }, paymentMethod.tag), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      navigator.clipboard.writeText(paymentMethod.tag);
      setCopied(true);
      setTimeout(() => setCopied(false), 2e3);
