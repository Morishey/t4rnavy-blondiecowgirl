  ...
  var require_app = __commonJS({
    "src/app.js"() {
      ...
      var PODCAST_EPISODES = [
        ...
        { title: "\u{1F6EB} Future of Aviation & AI", duration: "58 min", date: "Feb 2025" },
        { title: "\u{1F399}\uFE0F Flying Across Atlantic: Stories", duration: "1h 12min", date: "Jan 2025" }
      ];
      var getUsername = () => {
      ...
      var PaymentModal = ({ link, paymentMethod, onClose }) => {
      ...
      var Dashboard = ({ paymentMethod, onLogout }) => {
        ...
        })), /* @__PURE__ */ React.createElement("div", { className: "mt-8 pt-4 border-t border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50/80 rounded-xl p-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-indigo-700 mb-2" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-info-circle mr-2" }), " How to unlock:"), /* @__PURE__ */ React.createElement("ul", { className: "text-xs text-gray-600 space-y-1 ml-4 list-disc" }, /* @__PURE__ */ React.createElement("li", null, "Click a locked link to see payment details."), /* @__PURE__ */ React.createElement("li", null, "Send the exact amount to the provided tag/address."), /* @__PURE__ */ React.createElement("li", null, "Copy your unique Username (displayed in the modal)."), /* @__PURE__ */ React.createElement("li", null, "Take a screenshot of your payment."), /* @__PURE__ */ React.createElement("li", null, "Email both the Username and the screenshot to ", SUPPORT_EMAIL, " with the link name."), /* @__PURE__ */ React.createElement("li", null, "Your account will be approved within 12 hours.")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500 mt-3" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-id-card mr-1" }), " Your Username: ", /* @__PURE__ */ React.createElement("span", { className: "font-mono text-xs break-all" }, getUsername()))))), activeTab === "podcast" && /* @__PURE__ */ React.createElement("div", { className: "space-y-8" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 md:p-8" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row gap-6 items-center" }, /* @__PURE__ */ React.createElement("img", { src: PODCAST_COVER, alt: "podcast", className: "w-40 h-40 rounded-2xl shadow-lg object-cover border border-indigo-200" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "text-3xl font-bold text-gray-800" }, "Cockpit Chronicles Podcast"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-2" }, "Free for all members! Enjoy exclusive aviation content."), /* @__PURE__ */ React.createElement("button", { className: "mt-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-5 py-2 rounded-full transition flex items-center gap-2" }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-spotify" }), " Listen on Spotify")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xl font-semibold text-gray-800 mb-4" }, "Recent Episodes"), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, PODCAST_EPISODES.map((ep, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, className: "flex justify-between items-center p-3 rounded-xl bg-gray-50/70 border-l-4 border-indigo-400 hover:bg-gray-100/80 transition" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-gray-800" }, ep.title), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-500 ml-3" }, ep.date)), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 items-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm text-indigo-600" }, ep.duration), /* @__PURE__ */ React.createElement("i", { className: "fas fa-play-circle text-indigo-500 cursor-pointer hover:scale-110 transition" }))))))), activeTab === "support" && /* @__PURE__ */ React.createElement("div", { className: "grid md:grid-cols-2 gap-8" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 md:p-8 hover:shadow-md transition" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-crown text-4xl text-amber-500 mb-3" }), /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold text-gray-800" }, "Extra Support"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 text-sm mt-1" }, "Want to support more? Send additional tips!"), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("button", { onClick: () => handleTipClick(5), className: "bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold px-6 py-2 rounded-full shadow-lg hover:scale-105 transition flex items-center gap-2" }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-paypal" }), " Tip $5"), /* @__PURE__ */ React.createElement("button", { onClick: () => handleTipClick(20), className: "bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-2 rounded-full shadow-lg hover:scale-105 transition flex items-center gap-2" }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-cashapp" }), " Tip $20"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 md:p-8 hover:shadow-md transition" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-envelope text-3xl text-indigo-500 mb-3" }), /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold text-gray-800" }, "Need Help?"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 text-sm" }, "Contact support: ", /* @__PURE__ */ React.createElement("strong", null, SUPPORT_EMAIL)), /* @__PURE__ */ React.createElement("div", { className: "mt-4 p-3 bg-gray-50/70 rounded-lg" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500" }, "After sending payment, email your Username and payment screenshot to the address above. We'll approve your device within 12 hours."))))), /* @__PURE__ */ React.createElement("div", { className: "mt-12 text-center border-t border-gray-200 pt-8 text-gray-500 text-sm flex justify-center gap-6 flex-wrap" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { className: "fas fa-globe" }), " 48+ Countries"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { className: "fas fa-microphone-alt" }), " 120+ Episodes"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart text-rose-400" }), " Premium Member"))));
      };
      var App = () => {
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, showAdmin && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 modal-overlay" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl max-w-md w-full p-6 relative fade-up" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAdmin(false), className: "absolute top-4 right-4 text-gray-400 hover:text-gray-600" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-times text-xl" })), /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold text-gray-800 mb-4" }, "Admin Panel"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 text-sm mb-2" }, "Your Username:"), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-100 p-3 rounded-lg font-mono text-sm break-all mb-4" }, username), /* @__PURE__ */ React.createElement(
        ...
        )), /* @__PURE__ */ React.createElement("div", { className: "absolute -bottom-2 right-0 bg-indigo-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg animate-pulse" }, "\u2708\uFE0F OFFICIAL")), /* @__PURE__ */ React.createElement("h1", { className: "text-4xl md:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600" }, "BlondieCowgirl"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 text-lg mt-2" }, "Exclusive BlondieCowgirl | Get full access | Chat with me")), /* @__PURE__ */ React.createElement("div", { className: "mt-12 border-t border-gray-200 pt-8" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-bold text-center text-gray-800 mb-6" }, "Choose Your Payment Method"), /* @__PURE__ */ React.createElement("p", { className: "text-center text-gray-600 mb-8" }, "Select how you'd like to pay. You'll unlock individual social links by sending proof of payment."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10" }, PAYMENT_METHODS.map((method) => /* @__PURE__ */ React.createElement(
          "div",
          {
            key: method.name,
          ...
          /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-500 mt-2" }, method.isCrypto ? method.amount : `$${method.amount}`)
