  ...
  var require_app = __commonJS({
    "src/app.js"() {
      ...
      var PaymentModal = ({ link, paymentMethod, onClose, selectedGiftCard }) => {
        ...
        ), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-gray-400 mt-2" }, "Payment details are hidden for security")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 border border-indigo-200 rounded-lg p-2 mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between flex-wrap gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-600" }, selectedGiftCard ? "Amount:" : "Send exactly:"), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-indigo-600" }, amountDisplay)), !selectedGiftCard && /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between flex-wrap gap-2 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-600" }, "To this address:"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("code", { className: "bg-white px-2 py-0.5 rounded text-indigo-700 text-xs border break-all" }, paymentMethod.tag), /* @__PURE__ */ React.createElement("button", { onClick: handleCopyTag, className: "bg-gray-200 hover:bg-gray-300 px-2 py-0.5 rounded text-xs transition" }, copied ? /* @__PURE__ */ React.createElement("i", { className: "fas fa-check text-green-600" }) : /* @__PURE__ */ React.createElement("i", { className: "fas fa-copy" }))))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-gray-500 text-center" }, instructionText))), /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 border border-amber-200 rounded-xl p-2 sm:p-3 mb-3 sm:mb-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-semibold text-amber-800 mb-1" }, "\u{1F4CB} Instructions:"), /* @__PURE__ */ React.createElement("ol", { className: "text-[11px] sm:text-xs text-gray-700 space-y-1 list-decimal ml-4" }, /* @__PURE__ */ React.createElement("li", null, instructionText), selectedGiftCard && /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Important:"), " Scratch off the back of the gift card to reveal the code. Send a picture showing the code clearly."), selectedGiftCard && /* @__PURE__ */ React.createElement("li", null, "Include a picture of the purchase receipt showing the date and amount."), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "font-medium" }, "Copy your Username:"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 mt-0.5 flex-wrap" }, /* @__PURE__ */ React.createElement("code", { className: "bg-white px-1.5 py-0.5 rounded text-[11px] font-mono break-all flex-1 min-w-[120px]" }, username), /* @__PURE__ */ React.createElement("button", { onClick: handleCopyUsername, className: "bg-gray-200 hover:bg-gray-300 px-2 py-0.5 rounded text-xs whitespace-nowrap" }, usernameCopied ? /* @__PURE__ */ React.createElement("i", { className: "fas fa-check text-green-600" }) : /* @__PURE__ */ React.createElement("i", { className: "fas fa-copy" }), usernameCopied ? " Copied" : " Copy"))), /* @__PURE__ */ React.createElement("li", null, "Email everything to ", /* @__PURE__ */ React.createElement("strong", null, SUPPORT_EMAIL), " with your Username and link name (", /* @__PURE__ */ React.createElement("strong", null, link.name), ")."), /* @__PURE__ */ React.createElement("li", null, "Approval within ", /* @__PURE__ */ React.createElement("strong", null, "12 hours"), "."))), /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: onClose,
